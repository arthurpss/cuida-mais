...
(
    ...
    cuidador_cpf VARCHAR(11)                             NOT NULL,
    CONSTRAINT pk_endereco_cuidador PRIMARY KEY (id)
);
...
ALTER TABLE endereco_cuidador
    ADD CONSTRAINT uc_endereco_cuidador_cep UNIQUE (cep);

ALTER TABLE endereco_paciente
    ADD CONSTRAINT uc_endereco_paciente_cep UNIQUE (cep);
...
ALTER TABLE alergia
    ADD CONSTRAINT FK_ALERGIA_ON_PRONTUARIO FOREIGN KEY (prontuario_id) REFERENCES prontuario (id);

ALTER TABLE certificacao
    ADD CONSTRAINT FK_CERTIFICACAO_ON_CURRICULO FOREIGN KEY (curriculo_id) REFERENCES curriculo (id);
...
ALTER TABLE comorbidade
    ADD CONSTRAINT FK_COMORBIDADE_ON_PRONTUARIO FOREIGN KEY (prontuario_id) REFERENCES prontuario (id);

ALTER TABLE curriculo
    ADD CONSTRAINT FK_CURRICULO_ON_CUIDADOR_CPF FOREIGN KEY (cuidador_cpf) REFERENCES cuidador (cpf);

ALTER TABLE dispositivo
    ADD CONSTRAINT FK_DISPOSITIVO_ON_PRONTUARIO FOREIGN KEY (prontuario_id) REFERENCES prontuario (id);

ALTER TABLE endereco_cuidador
    ADD CONSTRAINT FK_ENDERECO_CUIDADOR_ON_CUIDADOR_CPF FOREIGN KEY (cuidador_cpf) REFERENCES cuidador (cpf);

ALTER TABLE endereco_paciente
    ADD CONSTRAINT FK_ENDERECO_PACIENTE_ON_PACIENTE_CPF FOREIGN KEY (paciente_cpf) REFERENCES paciente (cpf);

ALTER TABLE experiencia
    ADD CONSTRAINT FK_EXPERIENCIA_ON_CURRICULO FOREIGN KEY (curriculo_id) REFERENCES curriculo (id);

ALTER TABLE formacao
    ADD CONSTRAINT FK_FORMACAO_ON_CURRICULO FOREIGN KEY (curriculo_id) REFERENCES curriculo (id);

ALTER TABLE prescricao
    ADD CONSTRAINT FK_PRESCRICAO_ON_PRONTUARIO FOREIGN KEY (prontuario_id) REFERENCES prontuario (id);

ALTER TABLE prontuario
    ADD CONSTRAINT FK_PRONTUARIO_ON_PACIENTE_CPF FOREIGN KEY (paciente_cpf) REFERENCES paciente (cpf);